...
This recommendation is the main foundation of the full deployment documentation, here we test the algorithm on Google Colab Environment. The full ipynb files can be seen [here](https://github.com/Fashionism-Bangkit-Capstone/Fashionism-Machine-Learning/blob/main/Initial_Recommendation_Algorithm.ipynb).
